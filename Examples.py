...
ecc1, rsa1 = node2.import_keys(keys_node1)
ecc2, rsa2 = node1.import_keys(keys_node2)

# node1 encrypt the message using node2's public rsa key
message_encrypt = node1.encrypt_message(rsa2, message)
print('\nencrypted message: ' + message_encrypt)

# create the transaction
tx1_at_node1 = Tx(0, ecc1.to_string().hex(), ecc2.to_string().hex(), 100, message_encrypt)
